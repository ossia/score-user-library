/*
{
    ...
    "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/3lsSzf by iq.  A happy and blobby creature jumping. It gets off-model very often, but it looks good enough. Making of and related math/shader/art explanations (6 hours long): [url]https://www.youtube.com/watch?v=Cfe5UQ-1L9Q[/url]. ",
    "IMPORTED": {
    },
    "INPUTS": [
    ]
