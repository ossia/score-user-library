/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/MsdGWn by And390.  A simple example of smoke-like curl noise. Based on simplex noise with FBM.",
  "INPUTS" : [
