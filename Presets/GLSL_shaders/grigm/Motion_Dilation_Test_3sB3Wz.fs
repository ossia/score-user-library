/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/3sB3Wz by granito.  \"It's Britney Bitch!\"",
  "PASSES" : [
    {
      "TARGET" : "BufferA",
      "PERSISTENT" : true,
...
void main() {
	if (PASSINDEX == 0)	{
	    ...
	    vec3 outcol = mix( IMG_NORM_PIXEL(inputImage_2,mod(uv + uvoffset * 0.01,1.0)),  IMG_NORM_PIXEL(BufferB,mod(uv + uvoffset * 0.005,1.0)), 0.8).rgb;
