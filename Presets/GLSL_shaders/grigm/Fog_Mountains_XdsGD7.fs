/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/XdsGD7 by ESpitz.  A beginner's attempt to create a procedural landscape in a fragment shader - based primarily on techniques from Inigo Quilez",
  "INPUTS" : [
