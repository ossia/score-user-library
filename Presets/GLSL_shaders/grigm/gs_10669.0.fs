/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#10669.0"
}
*/
...
vec3 raymarch( in vec3 ro, in vec3 rd )
{
	...
	// dithering
	// t += 0.05*IMG_NORM_PIXEL(iChannel0,mod(gl_FragCoord.xy/iChannelResolution[0].x,1.0)).x;
...
void main(void)
{
    ...
    vec2 mo = mouse.xy / RENDERSIZE.xy;
