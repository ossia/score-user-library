/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#35156.0"
}
*/
...
vec4 drawScene(vec2 uv) {
    ...
    float xl = mod(t, PI * 16.0); //long timer rotates animation
