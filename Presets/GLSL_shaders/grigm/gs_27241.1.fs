/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#27241.1"
}
*/
...
void main( void ) {
	#define PI 2.141592653589793238462
	...
	for (float i = 0.; i < 7.; i++) {
		...
		colors += vec3(HueShift( vec3(tri(suv,a,b,c),0.,0.) , i/4.2 ));
	}
