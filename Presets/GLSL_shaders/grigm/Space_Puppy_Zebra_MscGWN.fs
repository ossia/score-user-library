/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/MscGWN by reza.  Not sure what to call this. Its just me playing with Ray Marching a sphere, but doing it wrong and making beautiful things from mistakes. Enjoy! Code stolen from IQ. Thanks man! ",
  "INPUTS" : [
...
float sdSphere( vec3 p, float s )
{
		...
		float modValue = snoise( vec4( 1.0 * normalize( p ), 0.2 * TIME ) );
