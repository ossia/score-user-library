...
#define L   ; m.x= dot(u-a,v=b-a)/dot(v,v); o.z += D(m); o += D(clamp(m,center_line_dr1,center_line_dr2));
#define P     b=c= vec2(r.x,CUBE_H)/(CUBE_SIZE+r.y) L   b=a*I L   a=c*I L   a=c; r= I*r.yx;

void mainImage(out vec4 o, vec2 U)
{   vec2 v,m, I=vec2(1,-1), a,b,c=iResolution.xy, 
        u = (U+U-c)/c.y,
        r = sin((iTime*rot_speed)+rot_sin_amp*I); r += I*r.yx;
