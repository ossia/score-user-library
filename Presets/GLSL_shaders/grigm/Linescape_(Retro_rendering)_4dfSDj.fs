/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/4dfSDj by xbe.  Trying to simulate the retro look of first 3d terrain rendering in old games...",
  "INPUTS" : [
...
void main() {
    ...
    mat4 projmat = CreatePerspectiveMatrix(50., RENDERSIZE.x/RENDERSIZE.y, 0.1, 10.);
