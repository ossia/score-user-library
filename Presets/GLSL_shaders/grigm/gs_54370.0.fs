/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#54370.0"
}
*/
...
//#define HIGH_QUALITY
	...
	#define NOISE_LAYERS_COUNT 10.0
...
{ fragColor = vec4(0., 0., 0., 1.);
    ...
    vec3 cameraCenter = vec3(TIME * CAMERA_SPEED * -10.0, 0.0, 0.0);
