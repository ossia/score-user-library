/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#1944.0"
}
*/
...
void main( void ) {
	...
	vec3 rd = normalize( vec3( -1. + 1.5*uv* vec2(RENDERSIZE.x/RENDERSIZE.y, 1.0), -1.0 ) ); // ray destination
