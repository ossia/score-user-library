/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/4ss3DB by Flexi.  just a logarithmic zoom with a spiral twist and a division by zero in the complex number plane. 12 flower calculations, the rest is mirrored.",
  "INPUTS" : [
    {
      "NAME" : "iMouse",
      "TYPE" : "point2D"
...
void main() {
	...
	vec2 mouse_correct = 0.5 + ( iMouse.xy / RENDERSIZE.xy - 0.5) / aspect.yx;
