/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#35184.0",
  "INPUTS" : [
    {
      "NAME" : "mouse",
      "TYPE" : "point2D",
...
void main( void ) {
	...
	if (length(position-mouse) < mradius) {
		me.r = 0.5+0.9*sin(TIME * 1.234542);
		me.g = 0.5+0.9*sin(3.0 + TIME * 1.64242);
		me.b = 0.5+0.9*sin(4.0 + TIME * 1.444242);
	} else {
