/*{
    "CREDIT": "ossia score",
    "ISFVSN": "2",
    "DESCRIPTION": "Polar coordinate remapping. Converts between Cartesian and polar UV spaces. Forward (Cart→Polar) wraps the image into a tunnel/ring. Inverse (Polar→Cart) unwraps a radial image into a flat strip. Creates tunnels, wormholes, kaleidoscope wrapping, and radial symmetry effects.",
...
void main() {
    ...
    if (mode == 0) {
        ...
        // X → angle (0-1 = 0-2π), Y → radius (0-1 = center to edge)
