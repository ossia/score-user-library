/*{
  "DESCRIPTION": "cube",
  "CREDIT": "r21nomi (ported from https://www.vertexshaderart.com/art/QgXakG4wfDMZ4Au6n)",
  "ISFVSN": "2",
...
void main() {
   ...
   float snd = texture(sound, vec2(mix(0.1, 0.5, hash(scaleOffset)), hash(scaleOffset) / 5.0)).x;
