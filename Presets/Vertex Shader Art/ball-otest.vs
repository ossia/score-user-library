/*{
  "DESCRIPTION": "ball-otest",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/85e3bGEKFA4Ac7pHh)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s = texture(sound, vec2(mix(0.1, 0.5, hash(cv)), hash(cv) / 2. * .2)).r;
