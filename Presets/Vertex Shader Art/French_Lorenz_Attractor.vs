/*{
  "DESCRIPTION": "French Lorenz Attractor",
  "CREDIT": "aiekick (ported from https://www.vertexshaderart.com/art/bgatWdfJ85SuY4Fn3)",
  "ISFVSN": "2",
...
void main()
{
 ...
 float rk1 = dk1/(dk0*transitionStrength);
   ...
   float sk0 = -30. * texture(sound, vec2(0.0, (1.-rk0)*0.2)).x*0.5;
 float sk1 = 30. * texture(sound, vec2(0.1, (1.-rk1)*0.2)).x*0.5;
