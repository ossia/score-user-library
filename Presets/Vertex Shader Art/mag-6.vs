/*{
  "DESCRIPTION": "mag",
  "CREDIT": "trip-les-ix (ported from https://www.vertexshaderart.com/art/gb48Jjp6zYH7bcWGN)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(mix(0.2, 0.3, abs(atan(ca, cd)) / PI), length(vec2(ca,cd))) * .1).r;
