/*{
  "DESCRIPTION": "crystal irisz (mouse.xy) - 2017-07-13: replaced music",
  "CREDIT": "zugzwang404 (ported from https://www.vertexshaderart.com/art/Acb8NGnF3tJvv77Ji)",
  "ISFVSN": "2",
...
// float side = mix(-1., 1., step(0.5, mod(circleId, 2.)));
  ...
  float snd = texture(sound, vec2((cu + abs(uv.x * 1.8 - 0.3)-7.) * 0.05, uv.y * 0.4)).r;
