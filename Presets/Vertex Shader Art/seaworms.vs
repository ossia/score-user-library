/*{
  "DESCRIPTION": "seaworms",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/KRuXE4SBCi4kRBG6j)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd0 = texture(sound, vec2(mix(0.1, 0.3, pn), mix(0.0, 0.3, pn))).r;
  float snd1 = texture(sound, vec2(mix(0.1, 0.3, pn), mix(0.5, 0.12, pn))).r;
