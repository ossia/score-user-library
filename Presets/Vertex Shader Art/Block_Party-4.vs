/*{
  "DESCRIPTION": "Block Party - Mod\u00a0https://www.vertexshaderart.com/art/H65kA6jZ79o5qDjXG",
  "CREDIT": "macro (ported from https://www.vertexshaderart.com/art/MRTD3jA6zwi4pa9j6)",
  "ISFVSN": "2",
   ...
   for(int i=0; i<10; i++)
    {
        ...
        float snd = texture(sound, vec2(off + spread * fSize, r * speed + o)).r;
