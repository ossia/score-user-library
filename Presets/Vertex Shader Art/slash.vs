/*{
  "DESCRIPTION": "slash - music link update",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/rZcr6zk3jJKzwJ2mD)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd0 = texture(sound, vec2(0.13 + lineId * 0.05, quadId / quadCount * 0.01)).r;
  float snd1 = texture(sound, vec2(0.14 + lineId * 0.05, quadId / quadCount * 0.01)).r;
