/*{
  "DESCRIPTION": "thumpy forest - quick test",
  "CREDIT": "kolargon (ported from https://www.vertexshaderart.com/art/z5Wj5jyFwYiwezjLv)",
  "ISFVSN": "2",
...
void funk(const float vertexId, float vertexCount, float base, out vec3 pos, out vec4 color) {
  ...
  float s = texture(sound, vec2(.1, mix(0.9, 1.0, (1. - sv)))).r;
  float s2 = texture(sound, vec2(mix(0.05, 0.5, sideV), (1. - sv) * .4)).r;
