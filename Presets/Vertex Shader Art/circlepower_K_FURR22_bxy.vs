/*{
  "DESCRIPTION": "circlepower K FURR22 bxy",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/vEvaCS9R8ehpnLZPj)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s2 = texture(sound, vec2(mix(0.2, 0.5 /cu, gs), gt * (0.00005 + KP3))).r;
