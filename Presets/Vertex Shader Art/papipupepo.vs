/*{
  ...
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/7vsaPEdRhNyw6hBKg)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd2 = -2.0 /texture(sound,vec2(mix(0.001, 1., exp(atan(offset.x, offset.y) / PI )), length(offset) * .01)).r;
