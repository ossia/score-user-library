/*{
  "DESCRIPTION": "Circles from Triangles - duplicate",
  "CREDIT": "sangjin.lee (ported from https://www.vertexshaderart.com/art/Jpg8BhcLNg3DjTpT5)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(av * .05, av * .25)).r;
