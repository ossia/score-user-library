/*{
  "DESCRIPTION": "Audio Reactive Art donga.choi",
  "CREDIT": "donga.choi (ported from https://www.vertexshaderart.com/art/h8BkWLf8vzaHjSvsv)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(au * .05 ,av * .25 -7.)).r;
