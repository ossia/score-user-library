/*{
  "DESCRIPTION": "perc2 - Sigh.... someone took their music down so replacing the music but it's not really tuned for this.",
  "CREDIT": "zugzwang404 (ported from https://www.vertexshaderart.com/art/3b3a5MqLTPvBpcvhN)",
  "ISFVSN": "2",
...
void GetCubePosition( float fCubeId, float numCubes, out mat4 mat, out vec4 vCubeCol )
{
   ...
   vec3 vCubeOrigin = vec3( 0.0, 0.0, 0.0 );
    ...
    float snd = texture(sound, vec2(mix(0.01, 0.199, uP), ll * 0.3)).r;
