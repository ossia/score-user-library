/*{
  "DESCRIPTION": "oceanwave",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/JovmnYPALtpYmhbx3)",
  "ISFVSN": "2",
...
void main() {
  ...
  float historyV = (v * numLinesDown + 7.5) / IMG_SIZE(sound).y + 100.4;
