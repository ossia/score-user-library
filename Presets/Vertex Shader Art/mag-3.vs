/*{
  "DESCRIPTION": "mag",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/RdimY5SHzK3msAHm4)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(mix(.2, 1.3, abs(atan(ca, cd)) / PI), length(vec2(ca,cd))) * .1).r;
