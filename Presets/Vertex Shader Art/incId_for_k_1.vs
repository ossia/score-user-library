/*{
  "DESCRIPTION": "incId for k 1",
  "CREDIT": "zugzwang404 (ported from https://www.vertexshaderart.com/art/EGh5YgqAykhgd7zoM)",
  "ISFVSN": "2",
...
// s /= float(hist);
  float s = texture(sound, vec2(mix(0.5, .5, hash(cubeId * .723)), 0.)).r;
