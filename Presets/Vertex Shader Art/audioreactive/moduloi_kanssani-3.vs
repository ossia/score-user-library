/*{
  "DESCRIPTION": "moduloi kanssani",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/XwmMeBkJu6Bk2vv9o)",
  "ISFVSN": "2",
...
void GetCubePosition( float fCubeId, float numCubes, out mat4 mat, out vec4 vCubeCol )
{
   ...
   vec3 vCubeOrigin = vec3( -0.80, 0.3, 0.0 );
    ...
    float snd = texture(sound, vec2(mix(11.0, (12.), u+16.), u - 14.2)).r*10.;
    float s2 = texture(sound, vec2(mix(0.2, 1.2-cos(time/u), v), v + 1.05)).r/2.01/sin(mouse.x*snd);
