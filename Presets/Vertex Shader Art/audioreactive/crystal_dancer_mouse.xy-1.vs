/*{
  "DESCRIPTION": "crystal dancer (mouse.xy) - 2017-07-13: replaced music",
  "CREDIT": "zugzwang404 (ported from https://www.vertexshaderart.com/art/Suxnf3g4CqC5dLWw6)",
  "ISFVSN": "2",
...
// float side = mix(-1., 1., step(0.5, mod(circleId, 2.)));
  ...
  float snd = texture(sound, vec2((cu + abs(uv.x * 1.8 - 0.3)-7.) * 0.5, uv.y * 0.4)).r;
