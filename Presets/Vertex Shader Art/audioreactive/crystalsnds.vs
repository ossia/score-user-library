/*{
  "DESCRIPTION": "crystalsnds - 2017-07-13: replaced music",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/G6uv6rnTuzAgmHniY)",
  "ISFVSN": "2",
...
// float side = mix(-1., 1., step(0.5, mod(circleId, 2.)));
  ...
  float snd = texture(sound, vec2((cu + abs(uv.x * 2. - 1.)) * 0.05, uv.y * 0.4)).r;
