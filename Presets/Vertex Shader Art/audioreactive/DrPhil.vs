/*{
  "DESCRIPTION": "DrPhil - Use Dr. Phil song\nhttps://soundcloud.com/plu-collective/dr-phil",
  "CREDIT": "PLU Collective (ported from https://www.vertexshaderart.com/art/KRwzSvynXozMTXZ7w)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(au * .02, av * .25)).r;
