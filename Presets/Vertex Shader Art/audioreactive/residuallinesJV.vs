/*{
  "DESCRIPTION": "residuallinesJV",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/whWhE5dshEugnAaBD)",
  "ISFVSN": "2",
...
void main()
{
  ...
  float vold = 1.0*pow(texture(sound,vec2(u,0.81)).r,1.0);
  float x = (u*10.0)-1.0;
