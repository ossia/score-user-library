/*{
  "DESCRIPTION": "Circle From Triangle_seongwon.jang",
  "CREDIT": "seongwon.jang (ported from https://www.vertexshaderart.com/art/8jcBYJRBWjDcfHKkH)",
  "ISFVSN": "2",
...
void main() {
  ...
  float yoff = texture(sound,vec2(v,u)).r;//sin(time + x * 0.3) * 0.2;
