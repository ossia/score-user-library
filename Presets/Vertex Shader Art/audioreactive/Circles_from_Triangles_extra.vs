/*{
  "DESCRIPTION": "Circles from Triangles extra",
  "CREDIT": "junsujang-digipen (ported from https://www.vertexshaderart.com/art/rzriAAzqrAiYpiyWX)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(au * 0.05, av * .25)).r*(sin(time)*0.1 + 1.2)*1.;
