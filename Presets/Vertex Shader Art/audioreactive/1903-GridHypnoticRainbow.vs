/*{
  "DESCRIPTION": "1903-GridHypnoticRainbow",
  "CREDIT": "janalex (ported from https://www.vertexshaderart.com/art/C5XnDd3TxCtHq52Jv)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(au * 0.05, av * 0.25)).x;
