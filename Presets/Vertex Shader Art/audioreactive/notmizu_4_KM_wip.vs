/*{
  "DESCRIPTION": "notmizu 4 KM wip",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/8xXukzezXszWuCGEN)",
  "ISFVSN": "2",
...
//parameter3* mouse.y;
  float ss =
  texture(sound, vec2(fract(hash(qu + qv) + qv + time * 0.5*parameter3), 0.-parameter3)).r;
