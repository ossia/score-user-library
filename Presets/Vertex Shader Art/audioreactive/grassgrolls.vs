/*{
  "DESCRIPTION": "grassgrolls",
  "CREDIT": "aleon (ported from https://www.vertexshaderart.com/art/ev52maygjcBnfCzwC)",
  "ISFVSN": "2",
...
void main() {
  ...
  float sv = abs(loc.y);
  float s = texture(sound, vec2(mix(0.1, 0.2, su), mix(0.0, 0.2, sv))).r;
