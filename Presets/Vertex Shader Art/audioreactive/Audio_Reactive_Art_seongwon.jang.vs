/*{
  "DESCRIPTION": "Audio Reactive Art_seongwon.jang",
  "CREDIT": "seongwon.jang (ported from https://www.vertexshaderart.com/art/6Xdd5o4awYpFcY4QM)",
  "ISFVSN": "2",
...
void main() {
  ...
  float v = y / (across - 1.);
    ...
    float s = texture(sound, vec2(u,v)).r ;
