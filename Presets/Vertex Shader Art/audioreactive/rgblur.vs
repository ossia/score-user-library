/*{
  "DESCRIPTION": "rgblur",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/jgwXiSzEkQzK3X2Fx)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s = texture(sound, vec2(mix(0.05, 0.5, (cx + cy * across) / numCubes), spotV * 0.01)).r;
  float s2 = texture(sound, vec2(mix(0.05, 0.5, (cx + cy * across) / numCubes), spotV * 0.0)).r;
