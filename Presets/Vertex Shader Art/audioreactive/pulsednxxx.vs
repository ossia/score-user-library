/*{
  "DESCRIPTION": "pulsednxxx",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/7G88sy7oNibcANkMP)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s = texture(sound, vec2(mix(0.1, 0.15, abs(gv * 2. - 1.)), 0)).r;
