/*{
  "DESCRIPTION": "tutorial-4-1 audio reactive",
  "CREDIT": "eugene (ported from https://www.vertexshaderart.com/art/wKpLsESkrBXCiRJad)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(su * 0.05, sv * .25)).r;
