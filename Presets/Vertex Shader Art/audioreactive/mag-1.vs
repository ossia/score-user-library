/*{
  "DESCRIPTION": "mag",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/N3hXFQfEHwQ9N3TkC)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(mix(0.1, 0.5, abs(atan(ca, cd)) / PI), length(vec2(ca,cd))) * .1).r;
