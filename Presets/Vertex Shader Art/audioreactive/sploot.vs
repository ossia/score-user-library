/*{
  "DESCRIPTION": "sploot",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/EhoHuSv6ou8bp9o66)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(mix(0.002, 0.008, sv), sy * 0.5)).r;
  float sn2 = texture(sound, vec2(mix(0.01, 0.3, sy), sv * 0.5)).r;
