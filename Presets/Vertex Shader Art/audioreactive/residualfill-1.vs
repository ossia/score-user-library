/*{
  "DESCRIPTION": "residualfill",
  "CREDIT": "spotline (ported from https://www.vertexshaderart.com/art/iPiDjpBYDPGFTGp8Y)",
  "ISFVSN": "2",
...
void main()
{
  ...
  float vold = 1.0*pow(texture(sound,vec2(u,0.03)).r,7.0);
  float x = (u*60.0)-1.0;
