/*{
  "DESCRIPTION": "Sound Reactive Basic - Sound Reactive Test",
  "CREDIT": "cjensen93 (ported from https://www.vertexshaderart.com/art/viP5QEyt8HBLNEEbD)",
  "ISFVSN": "2",
...
void main(){
  ...
  float sound = texture(sound, vec2(u * 0.125,0.0)).r;
