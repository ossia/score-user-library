/*{
  "DESCRIPTION": "justlines",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/8MRZuPQnb7riyBLat)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s0 = texture(sound, vec2(mix(.01, .5, g0), 0)).r;
  float s1 = texture(sound, vec2(mix(.01, .5, g1), gv * .25)).r;
