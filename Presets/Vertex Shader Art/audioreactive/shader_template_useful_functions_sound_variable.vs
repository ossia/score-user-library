/*{
  "DESCRIPTION": "shader template, useful functions + sound variable",
  "CREDIT": "floppafilms google emails (ported from https://www.vertexshaderart.com/art/dPFqiAgc3g3evvDtS)",
  "ISFVSN": "2",
