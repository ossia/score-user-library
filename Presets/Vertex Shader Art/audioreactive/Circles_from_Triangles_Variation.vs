/*{
  "DESCRIPTION": "Circles from Triangles Variation",
  "CREDIT": "minsu-kim-digipen (ported from https://www.vertexshaderart.com/art/7QAPWrZErhyBDRnKb)",
  "ISFVSN": "2",
...
void main()
{
  ...
  float snd = texture(sound, vec2(au * .0, av * .15)).g;
