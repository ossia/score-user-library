/*{
  "DESCRIPTION": "technokokoro",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/NhWzyi4RTkjqEik5t)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s1 = texture(sound, vec2(abs(0.1), length(vec3(ca, cb, cc)) * .1)).r;
  float s2 = texture(sound, vec2(abs(0.2), length(vec3(ca, cb, cc)) * .1)).r;
