/*{
  "DESCRIPTION": "sirp",
  "CREDIT": "trip-les-ix (ported from https://www.vertexshaderart.com/art/BRW6CMT6qxyD5Qxs3)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s2 = texture(sound, vec2(0.5, 0.)).r * 2.;

  float s = texture(sound, vec2(fract(cv * mix(3., 20., fract(s2))),0)).r;
