/*{
  ...
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/QHfQoa4YycdGxqd8r)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd2 = texture(sound, vec2(mix(0.001, 0.121, abs(atan(offset.x, offset.y) / PI )), length(offset) * 0.1)).r;
