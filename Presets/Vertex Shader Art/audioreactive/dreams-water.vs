/*{
  "DESCRIPTION": "dreams-water",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/vFe83XLQLWckPmxFd)",
  "ISFVSN": "2",
...
// float snd = texture(sound, vec2(mix(0.1, 0.25, hash(cubeId)), length(cpos) * .05)).r;
