/*{
  ...
  "CREDIT": "zug (ported from https://www.vertexshaderart.com/art/8wij3k6mQCLMeYsgw)",
  "ISFVSN": "2",
  ...
  "INPUTS": [ { "LABEL": "Volume", "NAME": "volume", "TYPE": "audioFloatHistogram" }, { "LABEL": "Background", "NAME": "background", "TYPE": "color", "DEFAULT": [ 0.25, 0.59, 0.9, 1.0 ] }, { "LABEL": "Sound", "NAME": "sound", "TYPE": "audioHistogram" } ],
  "METADATA": {
    "ORIGINAL_VIEWS": 212,
    "ORIGINAL_DATE": {
      "$date": 1642075047484
...
float Snd =texture(sound,vec2(1)).r;
    float s = sin( angle );
    float c = cos( angle );
