/*{
  "DESCRIPTION": "circlepower K FURR",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/GhwS34Ee6m4sZemgY)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s = texture(sound, vec2(mix(0.01, 0.5, gs)/KP1, 0.2)).r;
  float s2 = texture(sound, vec2(mix(0.01, 0.5, gs), gt * 0.05)).r;
