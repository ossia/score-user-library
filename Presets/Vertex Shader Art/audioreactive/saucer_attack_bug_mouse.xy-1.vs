/*{
  ...
  "CREDIT": "zugzwang404 (ported from https://www.vertexshaderart.com/art/uXG7SrNumn9NcWxDE)",
  "ISFVSN": "2",
...
// float sideId = floor(circleId / 2.);
  ...
  float snd = texture(sound, vec2((cu + abs(uv.x / uv.y/.8 - 0.3)*7.)* 0.05, uv.y * 2.4)).r;
