/*{
  "DESCRIPTION": "unnamed",
  "CREDIT": "visa-valtteri (ported from https://www.vertexshaderart.com/art/wjw5e9cStNy6XAxH4)",
  "ISFVSN": "2",
...
vec3 gSunColor = vec3(1.0, 1.2, 1.4) *7.0;
...
void GetCubePosition( float fCubeId, float numCubes, out mat4 mat, out vec4 vCubeCol )
{
   ...
   vec3 vCubeOrigin = vec3( 0.0, 0.0, 0.0 );
    ...
    float snd = texture(sound, vec2(mix(0.0, 0.0135, abs(a / PI)), r * 0.3)).r;
