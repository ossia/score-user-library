/*{
  "DESCRIPTION": "htn",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/GMo8BydtF9nZHuqcM)",
  "ISFVSN": "2",
...
void GetCubePosition( float fCubeId, float numCubes, out mat4 mat, out vec4 vCubeCol )
{
   ...
   vec3 vCubeOrigin = vec3( 0.0, 0.0, 0.0 );
    ...
    //float s1 = texture(sound, vec2(mix(0.000, 0.015, hash(u * v * 0.137), v * 0.1)).r;
    float s2 = texture(sound, vec2(mix(0.015, 0.04, hash(u * v + 2.34)), hash(v) * 0.05)).r;
