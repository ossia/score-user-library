/*{
  "DESCRIPTION": "Audio Reactive Art by Juhong Mo",
  "CREDIT": "juhong.mo (ported from https://www.vertexshaderart.com/art/HFBbsCKy7Ypjr3eRc)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(av * .25, au * .05)).r;
