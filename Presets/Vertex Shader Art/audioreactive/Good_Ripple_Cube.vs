/*{
  "DESCRIPTION": "Good Ripple Cube",
  "CREDIT": "macro (ported from https://www.vertexshaderart.com/art/siiR5CkBzKcRp6keX)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s = texture(sound, vec2(mix(0.1, 0.5, su), (sv) / 2. * .2)).r;
