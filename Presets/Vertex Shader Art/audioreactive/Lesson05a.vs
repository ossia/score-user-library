/*{
  "DESCRIPTION": "Lesson05a - Lesson Five tutorial code.",
  "CREDIT": "PLU Collective (ported from https://www.vertexshaderart.com/art/BfGdpEhnBZQzXay29)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(au * .09, av * .25)).r;
