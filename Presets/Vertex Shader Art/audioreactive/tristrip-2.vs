/*{
  ...
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/RYrCnYygNSqgtTDKi)",
  "ISFVSN": "2",
...
float sample_ =texture(sound, (gl_Position.xy+1.0)/2.0 ).r;
   gl_PointSize=sample_*3.0;
