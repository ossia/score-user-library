/*{
  ...
  "CREDIT": "junsujang-digipen (ported from https://www.vertexshaderart.com/art/7pH6w9DYZF7bjFqRC)",
  "ISFVSN": "2",
...
void main() {
  ...
  //
  vec4 soundVal = texture(sound, vec2(0.));
  //
  ...
  vec3 pos = posf(t,i);
  soundVal = texture(sound, vec2(pos));
  vec3 ofs = vec3(0);
