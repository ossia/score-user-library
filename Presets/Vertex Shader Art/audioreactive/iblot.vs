/*{
  "DESCRIPTION": "iblot",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/NR42qFZjAfmdmw6oR)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s = texture(sound, vec2(mix(0.01, 0.04, abs(cu * 2. - 1.)), 0.)).r;
  float s2 = texture(sound, vec2(0.125, abs(cu * 2. - 1.) * .1)).r;
