/*{
  "DESCRIPTION": "h-t",
  "CREDIT": "macro (ported from https://www.vertexshaderart.com/art/WswhQKGQNaZzQhtqz)",
  "ISFVSN": "2",
...
// snd = pow(snd, mix(2., 0.5, u));
  ...
  float snd2 = texture(sound, vec2(mix(0.001, 0.021, abs(atan(offset.x, offset.y) / PI )), length(offset) * 0.1)).r;
