/*{
  "DESCRIPTION": "moduloi kanssani2",
  "CREDIT": "visa-valtteri (ported from https://www.vertexshaderart.com/art/KYv8eW5R2AYwLSdtm)",
  "ISFVSN": "2",
...
void GetCubePosition( float fCubeId, float numCubes, out mat4 mat, out vec4 vCubeCol )
{
   ...
   vec3 vCubeOrigin = vec3( 0.0, 0.0, 0.0 );
    ...
    float snd = texture(sound, vec2(mix(1.0, 0.2, u/16.), v * 4.2)).r*10.;
    float s2 = texture(sound, vec2(mix(0.001, 0.002, u), v * 00.05)).r*0.1-sin(time*3.);
