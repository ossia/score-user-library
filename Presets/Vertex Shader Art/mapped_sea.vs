/*{
  "DESCRIPTION": "mapped sea",
  "CREDIT": "\u512a\u6597 (ported from https://www.vertexshaderart.com/art/pXFLLtyZTzr6G4BSt)",
  "ISFVSN": "2",
...
void main() {
  ...
  float ss = texture(sound, vec2(fract(hash(qu) + qv + time * 0.5) + sin(time) * 1.5, 1.)).r;
