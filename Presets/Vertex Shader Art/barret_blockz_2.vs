/*{
  "DESCRIPTION": "barret blockz   2",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/Av2MKnW2EJCyL2soB)",
  "ISFVSN": "2",
...
float sndx = texture(sound, vec2(hash(11.-fCubeId) * mouse.y*8.125, 10.*mouse)).r;
    mat4 mCube;
    vec4 vCubeCol;
    vec3 vCubePos;
    float snd = texture(sound, vec2(hash(fCubeId) * mouse.y*1.125, 0)).r;
