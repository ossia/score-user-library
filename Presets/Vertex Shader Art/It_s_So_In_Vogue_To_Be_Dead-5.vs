/*{
  ...
  "CREDIT": "sylistine (ported from https://www.vertexshaderart.com/art/Eb8KT9CKPyKMXSF7L)",
  "ISFVSN": "2",
...
void main() {
  ...
  float outgoingR = texture(sound, soundTexCoords0).r * (1. - soundTexCoords0.y/(historyDepth * 2.));
  float incomingR = texture(sound, soundTexCoords1).r * (1. - soundTexCoords1.y/(historyDepth * 2.));
