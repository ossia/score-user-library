/*{
  "DESCRIPTION": "spiralNoise",
  "CREDIT": "richtowns (ported from https://www.vertexshaderart.com/art/fDPvNsyqX8zmv9hxa)",
  "ISFVSN": "2",
...
void main () {
  ...
  float sndFactor = texture(sound, vec2(mod(v, 1.), mod(v, 240.))).r;
