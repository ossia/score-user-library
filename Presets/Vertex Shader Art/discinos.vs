/*{
  "DESCRIPTION": "discinos",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/a75Aou3fJGMJjXG5r)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(mix(0.1, 0.5, fract(abs(atan(ca, cd)) / PI + time * .1)), length(vec2(ca,cd))) * .5).r;
