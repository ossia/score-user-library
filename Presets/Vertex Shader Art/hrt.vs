/*{
  "DESCRIPTION": "hrt",
  "CREDIT": "tapos (ported from https://www.vertexshaderart.com/art/4bxrvzvhcfEAq6Qzo)",
  "ISFVSN": "2",
...
void GetCubePosition( float fCubeId, float numCubes, out mat4 mat, out vec4 vCubeCol )
{
   ...
   vec3 vCubeOrigin = vec3( 0.0, 0.0, 0.0 );
    ...
    float snd = texture(sound, vec2(mix(0.0, 0.2, u), v * 0.1)).r;
    float s2 = texture(sound, vec2(mix(0.001, 0.02, u), v * 0.05)).r;
