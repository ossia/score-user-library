/*{
  ...
  "CREDIT": "james2 (ported from https://www.vertexshaderart.com/art/o3iK4vsbQQx2dD4jM)",
  "ISFVSN": "2",
...
point getPoint(float i, float soundIn) {
  ...
  float snd =soundIn;// pow(texture(sound, vec2(0.005, spike*0.025)).r, 4.);
...
void main() {
  float snd = movingAverage(pow(texture(sound, vec2(0.005, 0.5)).r, 4.)) * 1.;
  //float snd = pow(texture(sound, vec2(0.005, 0.025)).r, 4.);
