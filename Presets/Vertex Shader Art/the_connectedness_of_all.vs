/*{
  "DESCRIPTION": "the connectedness of all",
  "CREDIT": "visy (ported from https://www.vertexshaderart.com/art/mfEsB2oGhBqM3k3Rt)",
  "ISFVSN": "2",
...
void main() {
 ...
 float NUM_SEGMENTS = 0.1+localTime*0.00000001-texture(sound,vec2(vertexId*0.001,vertexId*0.001)).r*0.0001;
