/*{
  "DESCRIPTION": "vu-spike-ball",
  "CREDIT": "molotovbliss (ported from https://www.vertexshaderart.com/art/hJS9jEgToDSA94vDA)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s = texture(sound, vec2(mix(10.1, .005, hash(qu+qv)), mix(0., .012, hash(qv)))).r;
