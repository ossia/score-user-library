/*{
  "DESCRIPTION": "crystal iriszhr (1)",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/uQNhYXZtikXJR6MBz)",
  "ISFVSN": "2",
...
// float side = mix(-1., 1., step(0.5, mod(circleId, 2.)));
  ...
  float snd = texture(sound, vec2((cu + tan(uv.x * 1.8 / 2.)) * 0.05, uv.y * 2.4)).r;
