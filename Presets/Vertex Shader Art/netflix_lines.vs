/*{
  "DESCRIPTION": "netflix lines",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/P4e5h3iG9MkcanmBM)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd = texture(sound, vec2(fract(count / sin(128.0)), fract(count / 20000.0))).r;
