/*{
  "DESCRIPTION": "HexGrid2 - mouse for control shape pattern",
  "CREDIT": "trip-les-ix (ported from https://www.vertexshaderart.com/art/ZfXn2xm6JJh3o5b7T)",
  "ISFVSN": "2",
...
// Created by Stephane Cuillerdier - Aiekick/2017 (twitter:@aiekic// License Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License.
...
void main()
{
 ...
 float ringCircle = floor(sqrt((4. * indexCircle - 0.3) / 9.0) *1.5+kp0) - 1.0;;
    ...
    float snd = texture(sound, vec2(2.1, ringCircle * 0.21)*.21).r * 3.;
   float snd2 = texture(sound, vec2(.15, ringCircle * 0.4e1)*.01).r * 2.;
