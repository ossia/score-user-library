/*{
  "DESCRIPTION": "old greg kmachine wip",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/kFw99h7A55BoqmFND)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s = texture(sound, vec2(mix(0.005, 0.5, hash(fract(gv * 5.))*0.4), 0.)).r * 1.3;
