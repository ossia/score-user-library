/*{
  "DESCRIPTION": "headrush",
  "CREDIT": "gman (ported from https://www.vertexshaderart.com/art/sHdHwHQ9GTSaJ9j99)",
  "ISFVSN": "2",
...
void main() {
  ...
  float snd0 = texture(sound, vec2(0.13 + lineId * 0.005, quadId / quadCount * 0.01)).r;
  float snd1 = texture(sound, vec2(0.14 + lineId * 0.005, quadId / quadCount * 0.01)).r;
