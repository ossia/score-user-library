/*{
  "DESCRIPTION": "Spiral-TRIdNCE1",
  "CREDIT": "zugzwang404 (ported from https://www.vertexshaderart.com/art/XRdg3Wi744WAEMHKZ)",
  "ISFVSN": "2",
...
void main() {
  ...
  vec4 m = texture(touch, vec2(0., vertexId * 0.05));
  vec2 xy = vec2(x, y);
