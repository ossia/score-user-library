/*{
  "DESCRIPTION": "Sound Reactive End - Sound Reactive Advanced",
  "CREDIT": "cjensen93 (ported from https://www.vertexshaderart.com/art/5hf6Sm43wvfKW9tvA)",
  "ISFVSN": "2",
...
void main(){
  ...
  float sound = texture(sound, vec2(angleU * 0.125, angleV * 0.125)).r;
