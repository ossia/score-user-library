/*{
  "DESCRIPTION": "musicboxes",
  "CREDIT": "galousis (ported from https://www.vertexshaderart.com/art/njNz396TwkoZ7JoLd)",
  "ISFVSN": "2",
...
void main(void)
{
  ...
  float snd = texture(sound, vec2(thingV * 0.5 + 0.01, mod(thingV * 4., 4.) * 6. / 24.)).r*mix(.5, 1.5, 0.8);
