/*{
  "DESCRIPTION": "crystal dancer (mouse.xy) 2 - 2017-07-13: replaced music",
  "CREDIT": "zugzwang404 (ported from https://www.vertexshaderart.com/art/EWTJuKrqGXLji3GwW)",
  "ISFVSN": "2",
...
// float side = mix(-1., 1., step(0.5, mod(circleId, 2.)));
  ...
  float snd = texture(sound, vec2((cu + abs(uv.x/ 0.8 - 1.3)-7.) * 0.5, uv.y * 0.4)).r;
