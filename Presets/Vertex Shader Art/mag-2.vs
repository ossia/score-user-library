/*{
  "DESCRIPTION": "mag",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/QmjXyegEDvGDmMNkK)",
  "ISFVSN": "2",
...
void main() {
 ...
 float vertexCount = 1666. *kp1;
  ...
  float snd = texture(sound, vec2(mix(0.42, 0.3, abs(atan(ca, cd)) / PI), length(vec2(ca,cd))) * .1).r;
