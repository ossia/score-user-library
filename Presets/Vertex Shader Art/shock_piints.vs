/*{
  "DESCRIPTION": "shock piints",
  "CREDIT": "anon (ported from https://www.vertexshaderart.com/art/iwn76AsDsRRmr5bae)",
  "ISFVSN": "2",
...
void main() {
  ...
  for (int sp = 0; sp < spots; ++sp) {
    ...
    totalSnd += invSds;
    snd += texture(sound, vec2(mix(0.001, 0.111, sps), sds * .09)).r *
