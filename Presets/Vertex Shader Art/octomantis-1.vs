/*{
  "DESCRIPTION": "octomantis",
  "CREDIT": "zug (ported from https://www.vertexshaderart.com/art/uPu4TCDWfH27uwcgs)",
  "ISFVSN": "2",
...
void main() {
 ...
 start + hash(sideId + 2.);
  ...
  float snd = texture(sound, vec2((cu - abs(uv.x * 1.8 *1.3)) * 0.5, uv.y * 120.4)).r;
