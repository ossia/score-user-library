/*{
  "DESCRIPTION": "circlepower K FURR22 bxyr",
  "CREDIT": "\u266b\u266a\u266d\u266e{{triplesix g}}\u266f\u266a\u266b (ported from https://www.vertexshaderart.com/art/n7ehxG4s62oNWw5S3)",
  "ISFVSN": "2",
...
void main() {
  ...
  float s2 = texture(sound, vec2(mix(0.2, 0.5 /cu, gs), gt * (0.05 + KP3))).r;
