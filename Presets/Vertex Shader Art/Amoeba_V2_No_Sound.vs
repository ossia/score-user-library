/*{
  "DESCRIPTION": "Amoeba V2 [No Sound] - Amoeba V2",
  "CREDIT": "james2 (ported from https://www.vertexshaderart.com/art/948aadGavoEeSXCac)",
  "ISFVSN": "2",
...
point getPoint(float i) {
  ...
  float snd = 0.; //pow(texture(sound, vec2(0.005, spike*0.025)).r, 4.);
